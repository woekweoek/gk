...
front_standing = pygame.image.load('gameimages/blue_imp_front.gif')
back_standing = pygame.image.load('gameimages/blue_imp_back.gif')
left_standing = pygame.image.load('gameimages/blue_imp_left.gif')
...
for animType in animTypes:
    imagesAndDurations = [('gameimages/blue_imp_%s.%s.gif' % (animType, str(num).rjust(3, '0')), 0.1) for num in range(6)]
